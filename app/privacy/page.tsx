  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Data opsional yang sensitif, seperti foto progres, gambar makanan, jawaban kesiapan, dan rute lokasi jogging apabila fitur tersebut digunakan.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Optional sensitive data, such as progress photos, meal images, readiness answers, and jogging location routes when those features are used.",
