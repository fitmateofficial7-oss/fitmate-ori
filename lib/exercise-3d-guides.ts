export type ExerciseScenePreset =
  | "bench-press"
  | "incline-press"
  | "lat-pulldown"
  | "seated-row"
...
const GUIDES: Record<string, Exercise3DGuide> = {
  "barbell-bench-press": {
...
export function getExercise3DGuide(
...
export function getCanonicalExerciseName(
  ...
  const guide = getExercise3DGuide(value, value, "en");
